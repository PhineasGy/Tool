...
tic
%% 使用者輸入
II_mode = "soft";                           % soft: 1, hard: 2 (目前僅支援 soft)

mask_mode = 0;                              % regional VZA: 選擇 B, C, Mask 資料夾
...
PS_list = [6,7,8,9];                        % for C. Must be same length of WD_list
...
INPUT = Input(VVA_center=VVA_center,HVA_center=HVA_center,...
        WD_list=WD_list,VVA_list=VVA_list,HVA_list=HVA_list,PS_list=PS_list,OPTION=OPTION);
